...
?>
<!-- wp:cover {"url":"<?php echo esc_url( $gnn_ph ); ?>","dimRatio":30,"minHeight":66,"minHeightUnit":"vh","isDark":false,"metadata":{"name":"Cover Image with Bold Heading and Button"},"align":"full","style":{"spacing":{"padding":{"top":"48px","right":"48px","bottom":"48px","left":"48px"},"margin":{"top":"0"}},"color":{"duotone":["rgb(42, 47, 103)","rgb(214, 194, 42)"]}}} -->
...
<h2 class="wp-block-heading has-text-align-center has-white-color has-text-color" style="font-size:100px;font-style:normal;font-weight:700;letter-spacing:0px;line-height:1;text-transform:uppercase">A centered bold headline goes here</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
